...
//	public String main2(@RequestParam(name="year", required=false) String year) {   // �Ʒ��� ���� 
...
//		public String main3(@RequestParam(name="year", required=true) String year) {   // �Ʒ��� ���� 
		public String main3(@RequestParam String year) {   
//		http://localhost/ch2/requestParam3         ---->> year=null   400 Bad Request. required=true�� 
